const wordCollection = {
    noun: ['brigand', 'goblet', 'sword', 'knight', 'dragon', 'peasant'],
    adjective: ['good', 'bad', 'cold', 'noble', 'humble', 'shining'],
    person: ['Jack', 'Susie', 'Archer', 'Garry', 'Roland', 'Arthur'],
    verb: ['store', 'hate', 'jelaous of', 'afraid of', 'looking for', 'hear'],
    place: ['castle', 'office building', 'camp', 'dungeon', 'seashore', 'cave']
};
